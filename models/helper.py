...
from splitalexnet import SplitAlexNet
from FT_vgg import FT_VGG
...
MODELS = (AlexNet, CaffeNet, GoogleNet, NiN, ResNet50, ResNet101, ResNet152, VGG16, SplitAlexNet, FT_VGG)
...
MODEL_DATA_SPECS = {
    ...
    SplitAlexNet:alexnet_spec(),
    FT_VGG: std_spec(batch_size=25)
}
